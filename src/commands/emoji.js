...
module.exports = {
  ...
  run: async (client, message, command, args, lang, guildInfo) => {
    ...
    if (!emoji) return message.author ? message.reply({content:lang.couldn_t_find_that_emoji,failIfNotExists:false/*NQN deleted it*/}) : message.editReply({content:lang.couldn_t_find_that_emoji});
